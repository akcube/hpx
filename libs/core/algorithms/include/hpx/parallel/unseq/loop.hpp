...
namespace hpx { namespace parallel { namespace util {
    ...
    namespace detail {
        ...
        struct unseq_loop_n
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static InIter
            call(InIter it, std::size_t count, F&& f){
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static InIter
            call(InIter it, std::size_t count, CancelToken& tok, F&& f)
            {
                HPX_IVDEP HPX_UNROLL HPX_VECTORIZE
                for (std::size_t i = 0; i < count; i++)
                {
        ...
        struct unseq_loop
        {
            ...
            {
                return unseq_loop_n<Begin>::call(it,
                    std::distance(it, end), HPX_FORWARD(F, f));
            }
            ...
            {
                return unseq_loop_n<Begin>::call(it,
                    std::distance(it, end), tok, HPX_FORWARD(F, f));
            }
        ...
        struct unseq_loop_ind
        {
            ...
            call(Begin it, End end, F&& f)
            {
                return unseq_loop_n_ind<Begin>::call(it,
                    std::distance(it, end), HPX_FORWARD(F, f));
            }
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE Begin tag_invoke(
        hpx::parallel::util::loop_t, hpx::execution::unsequenced_policy, Begin begin,
        End end, F&& f)
    {
        return detail::unseq_loop<Begin>::call(begin, end, HPX_FORWARD(F, f));
    }
    ...
    {
        return detail::unseq_loop<Begin>::call(
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE Begin tag_invoke(
        ...
        Begin begin, End end, F&& f)
    {
        return detail::unseq_loop_ind<Begin>::call(
            begin, end, HPX_FORWARD(F, f));
    }

    template <typename Begin, typename End, typename F>
    HPX_HOST_DEVICE HPX_FORCEINLINE Begin tag_invoke(
        hpx::parallel::util::loop_ind_t, hpx::execution::unsequenced_task_policy,
        Begin begin, End end, F&& f)
    {
        return detail::unseq_loop_ind<Begin>::call(
            begin, end, HPX_FORWARD(F, f));
    ...
    {
        return detail::unseq_loop2::call(first1, last1, first2, HPX_FORWARD(F, f));
    }
    ...
    {
        return hpx::parallel::util::detail::unseq_loop_n<Iter>::call(
    ...
    tag_invoke(hpx::parallel::util::loop_n_ind_t<ExPolicy>, Iter it,
        std::size_t count, F&& f)
    {
        return hpx::parallel::util::detail::unseq_loop_n_ind<Iter>::call(
            it, count, HPX_FORWARD(F, f));
    }
    ...
    tag_invoke(hpx::parallel::util::loop_idx_n_t<ExPolicy>,
        std::size_t base_idx, Iter it, std::size_t count, F&& f)
    {
        return hpx::parallel::util::detail::unseq_loop_idx_n<Iter>::call(
