...
namespace hpx { namespace parallel { namespace util {
    ...
    namespace detail {
        ...
        struct unseq_transform_loop_n
        {
            ...
            call(InIter HPX_RESTRICT it, std::size_t count, OutIter HPX_RESTRICT dest, F&& f)
            {
    ...
    tag_invoke(hpx::parallel::util::transform_loop_n_t<ExPolicy>, Iter HPX_RESTRICT it,
        std::size_t count, OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_loop_n<Iter>::call(
            it, count, dest, HPX_FORWARD(F, f));
    }
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE constexpr typename std::enable_if<
        hpx::is_unsequenced_execution_policy_v<ExPolicy>,
        std::pair<Iter, OutIter>>::type
    tag_invoke(hpx::parallel::util::transform_loop_n_ind_t<ExPolicy>, Iter HPX_RESTRICT it,
        std::size_t count, OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_loop_n_ind<Iter>::call(
            it, count, dest, HPX_FORWARD(F, f));
    }
    ...
    namespace detail {
        ...
        struct unseq_transform_loop
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                ...
                hpx::traits::is_random_access_iterator_v<OutIter>,
                std::pair<InIter, OutIter>>::type
            call(InIter HPX_RESTRICT it, InIter HPX_RESTRICT last, OutIter HPX_RESTRICT dest, F&& f)
            {
                return util::transform_loop_n<hpx::execution::unsequenced_policy>(
            ...
            call(InIter HPX_RESTRICT it, InIter HPX_RESTRICT last, OutIter HPX_RESTRICT dest, F&& f)
            {
                auto ret = util::transform_loop(hpx::execution::seq,
                    it, last, dest, HPX_FORWARD(F, f));
    ...
    {
        auto ret = detail::unseq_transform_loop<IterB>::call(
    ...
    namespace detail {
        ...
        struct unseq_transform_loop_ind
        {
            ...
            call(InIter HPX_RESTRICT it, InIter HPX_RESTRICT last, OutIter HPX_RESTRICT dest, F&& f)
            {
                return util::transform_loop_n_ind<hpx::execution::unsequenced_policy>(
                    it, std::distance(it, last), dest, HPX_FORWARD(F, f));
            }
    ...
    HPX_HOST_DEVICE
        ...
        tag_invoke(hpx::parallel::util::transform_loop_ind_t,
            ...
            IterE HPX_RESTRICT end, OutIter HPX_RESTRICT dest, F&& f)
    {
        auto ret = detail::unseq_transform_loop_ind<IterB>::call(
            it, end, dest, HPX_FORWARD(F, f));
        return util::in_out_result<IterB, OutIter>{
            HPX_MOVE(ret.first), HPX_MOVE(ret.second)};
    }
    ...
    namespace detail {
        ...
        struct unseq_transform_binary_loop_n
        {
            ...
            call(InIter1 HPX_RESTRICT first1, std::size_t count, InIter2 HPX_RESTRICT first2,
    ...
    tag_invoke(hpx::parallel::util::transform_binary_loop_n_t<ExPolicy>,
        InIter1 HPX_RESTRICT first1, std::size_t count, InIter2 HPX_RESTRICT first2,
        OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_binary_loop_n<InIter1, InIter2>::call(
            first1, count, first2, dest, HPX_FORWARD(F, f));
    }
    ...
    namespace detail {
        ...
        struct unseq_transform_binary_loop
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                ...
                util::in_in_out_result<InIter1, InIter2, OutIter>>::type
            call(InIter1 HPX_RESTRICT first1, InIter1 HPX_RESTRICT last1,
                InIter2 HPX_RESTRICT first2, InIter2 HPX_RESTRICT last2, OutIter dest, F&& f)
            {
                // clang-format off
    ...
    tag_invoke(hpx::parallel::util::transform_binary_loop_t<ExPolicy>,
        ...
        InIter2 HPX_RESTRICT first2, OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_binary_loop<InIter1, InIter2>::call(
            first1, last1, first2, dest, HPX_FORWARD(F, f));
    }
    ...
    tag_invoke(hpx::parallel::util::transform_binary_loop_ind_n_t<ExPolicy>,
        ...
        OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_binary_loop_ind_n<InIter1, InIter2>::call(first1, count, first2, dest, HPX_FORWARD(F, f));
    }
    ...
    namespace detail {
        ...
        struct unseq_transform_binary_loop_ind
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                ...
                hpx::traits::is_random_access_iterator_v<OutIter>,
                util::in_in_out_result<InIter1, InIter2, OutIter>>::type
            call(InIter1 HPX_RESTRICT first1, InIter1 HPX_RESTRICT last1, InIter2 HPX_RESTRICT first2,
                InIter2 HPX_RESTRICT last2, OutIter HPX_RESTRICT dest, F&& f)
            {
                // clang-format off
                std::size_t count = (std::min) (std::distance(first1, last1),
                    std::distance(first2, last2));
    ...
    tag_invoke(hpx::parallel::util::transform_binary_loop_ind_t<ExPolicy>,
        ...
        InIter2 HPX_RESTRICT first2, OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_binary_loop_ind<InIter1, InIter2>::call(first1, last1, first2, dest, HPX_FORWARD(F, f));
    }
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE typename std::enable_if<
        ...
        util::in_in_out_result<InIter1, InIter2, OutIter>>::type
    tag_invoke(hpx::parallel::util::transform_binary_loop_ind_t<ExPolicy>,
        InIter1 HPX_RESTRICT first1, InIter1 HPX_RESTRICT last1, InIter2 HPX_RESTRICT first2,
        InIter2 HPX_RESTRICT last2, OutIter HPX_RESTRICT dest, F&& f)
    {
        return detail::unseq_transform_binary_loop_ind<InIter1, InIter2>::call(first1, last1, first2, last2, dest,
            HPX_FORWARD(F, f));
    }
