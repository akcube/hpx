...
namespace hpx { namespace parallel { inline namespace v1 { namespace detail {
    ...
    struct unseq_reduce{
        ...
        HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
            ...
            T>::type call(ExPolicy&& policy, InIterB first, InIterE last,
            T init, Reduce&& r){
            return hpx::parallel::util::detail::reduce_n::reduce(first,
        ...
        HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
            hpx::traits::is_random_access_iterator_v<FwdIterB>,
            T>::type call(
            FwdIterB part_begin, std::size_t part_size, T init, Reduce r)
        {
            return hpx::parallel::util::detail::reduce_n::reduce(part_begin,
                part_size, HPX_FORWARD(T, init),
                HPX_FORWARD(Reduce, r), [&](auto const v) { return v; });
        }
        ...
        HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
            ...
            T>::type call(Iter1 first1, Sent last1,
            Iter2 first2, T init, Reduce&& r, Convert&& conv)
        {
            return hpx::parallel::util::detail::binary_reduce_n::reduce(
                first1, first2, std::distance(first1, last1), HPX_FORWARD(T, init),
                HPX_FORWARD(Reduce, r), HPX_FORWARD(Convert, conv));
        }
