...
void test_transform_binary_exception()
{
    ...
    test_transform_binary_exception(unseq, IteratorTag());
    test_transform_binary_exception(par_unseq, IteratorTag());

    test_transform_binary_exception_async(unseq(task), IteratorTag());
    test_transform_binary_exception_async(par_unseq(task), IteratorTag());
}
...
void test_transform_binary_bad_alloc()
{
    ...
    test_transform_binary_bad_alloc(unseq, IteratorTag());
    test_transform_binary_bad_alloc(par_unseq, IteratorTag());

    test_transform_binary_bad_alloc_async(unseq(task), IteratorTag());
    test_transform_binary_bad_alloc_async(par_unseq(task), IteratorTag());
}
